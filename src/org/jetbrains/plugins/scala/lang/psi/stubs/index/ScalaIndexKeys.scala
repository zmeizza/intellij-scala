...
object ScalaIndexKeys {
  ...
  val PACKAGE_OBJECT_KEY: StubIndexKey[java.lang.Integer, ScObject]  = StubIndexKey.createIndexKey("sc.package.object.fqn")
  val PACKAGE_OBJECT_SHORT_NAME_KEY: StubIndexKey[String, ScObject] = StubIndexKey.createIndexKey("sc.package.object.short")
